...
const ONBOARDING_PLANS = [
  {
    ...
    name: "Solo",
    price: 99,
    features: ["150 minutes/month", "Everything included", "Calendar integration", "Cancel anytime"],
  ...
  },
  {
    ...
    price: 199,
    popular: true,
    features: ["400 minutes/month", "Priority setup", "Square + Google Calendar", "Cancel anytime"],
  ...
  },
  {
    ...
    name: "Shop",
    price: 299,
    features: ["600 minutes/month", "Priority support", "Multi-groomer routing", "Cancel anytime"],
